var url1 = 'https://node-api.flipsidecrypto.com/api/v2/queries/8472912f-fb10-4048-a12e-74ea5ddc133a/data/latest'
        ...
        async function getData1(){
                    ...
                    all_voter.push(data[i].ALL_VOTER);
                    all_proposal.push(data[i].ALL_PROPOSAL);
                    ...
                    document.getElementById('all_voter').textContent = all_voter[0]
                    document.getElementById('all_proposal').textContent = all_proposal[0]
            ...
            y: {
                ...
                ticks:{ 
                    ...
                    font:{
                        ...
                        var url4 = 'https://node-api.flipsidecrypto.com/api/v2/queries/6e3a5858-d301-427e-acf0-fded9494feff/data/latest'
