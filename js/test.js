                ...
                async function getData2(){
                     ...
                     function getData3(){
                        ...
                        const options = {
                          ...
                          //  'X-API-KEY':'fa97a95c-45d3-44f2-8d86-48765080b156'
                            }
                          };
                        ...
                        async function callAPI_alchemy(){
                            const options = {
                                ...
                                headers: {
                                Accept: 'application/json',
                                'X-API-KEY':'gv3pST7rqcqRl4awawlkBiUE61saQUBG'
                                }
                              };
                            ...
                            fetch('https://eth-mainnet.g.alchemy.com/nft/v2/demo/getContractMetadata?contractAddress=${}',options)
                            .then(res => {
                                return res.json();
                              })
                              .then((data) => {
                                contractName.push(data);
